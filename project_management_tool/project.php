...
.b2:hover{
  ...
  text-decoration:none;
    ...
    <a class="f3"  href="logout.php">LOG OUT</a>
            ...
            <center>
              <a class="f5" href="new project.html">Add New project</a>
          </center>
          
          <div class="container mt-5 shadow-lg p-3 mb-5 bg-white rounded rounded-right"> 
              <h3 class="card-header bg-success text-white text-center">DISPLAYING PROJECT DETAILS</h3>
...
$records = mysqli_query($conn,"select * from projects"); // fetch data from database
echo"<table border='2'>
<tr>
<th>S.NO</th>
<th>PROJECT NAME</th>
