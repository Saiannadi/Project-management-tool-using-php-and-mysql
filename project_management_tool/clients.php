...
.b2:hover{
  ...
  text-decoration:none;
    ...
    <a class="f3"  href="logout.php">LOG OUT</a>
            ...
            <center>
              <a class="f5" href="newclient.html">Add New Client</a>
          </center>
          
          <div class="container mt-5 shadow-lg p-3 mb-5 bg-white rounded rounded-right"> 
              <h3 class="card-header bg-success text-white text-center">DISPLAYING CLIENT DETAILS</h3>
              <form action="sea.php" method="post">
              <div class="f1">
                <div class="form-group">
                <input type="text" class="form-control" name="sena" placeholder="ENTER CLIENT NAME TO SEARCH..">
                </div>
...
$records = mysqli_query($conn,"select * from clients"); // fetch data from database
echo"<table border='2'>
<tr>
<th>S.NO</th>
<th>CLIENT NAME</th>
...
while($data = mysqli_fetch_array($records))
{
  ...
  <tr>
    ...
    <td><a class="b1" href="edit.php?id=<?php echo $data['sno']; ?>">Edit</a> <a class="b2" href="dele1.php?id=<?php echo $data['sno']; ?>">Delete</a></td>
  </tr>	
